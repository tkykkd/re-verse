...
const typewriterText = "さあ、時間を味方につけよう。";
        ...
        >
          ...
          >
             ...
             <svg viewBox="0 0 100 100" className="w-full h-full fill-none stroke-universe-teal stroke-[2] opacity-80">
                ...
                <text x="50" y="55" className="fill-universe-prism text-[40px] font-display font-light" textAnchor="middle">R</text>
             </svg>
          </motion.div>
          ...
          <p className="text-universe-silver text-sm md:text-base tracking-[0.4em] uppercase opacity-70">
            逆転（REVERSE）、再誕（REBIRTH）、そして宇宙（UNIVERSE）。
          </p>
        </motion.div>
